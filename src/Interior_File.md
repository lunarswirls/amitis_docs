...
The interior file is used to describe a bodies interior conductivity in $\Omega$-meters (this is equivalent in literature to conductivity with inverted exponent sign where units are S/m). An arbitrary example can be seen here:
