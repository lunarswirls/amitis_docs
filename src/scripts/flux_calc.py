...
for sim_step in sim_steps:
    ...
    v01_mag_rps = np.sqrt(vx01_rps**2 + vy01_rps**2 + vz01_rps**2)
    v01_mag_cps = np.sqrt(vx01_cps**2 + vy01_cps**2 + vz01_cps**2)

    v03_mag_rps = np.sqrt(vx03_rps**2 + vy03_rps**2 + vz03_rps**2)
    v03_mag_cps = np.sqrt(vx03_cps**2 + vy03_cps**2 + vz03_cps**2)
    ...
    data = difference.squeeze()  # remove singleton dimension
